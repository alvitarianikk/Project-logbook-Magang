...
<tr><td><font color="#000000">Normal Time</td><td>:</td><td><input type="text" name="waktuus" size="35" maxlength="50"></td></tr>
<tr><td><font color="#000000">Name</td><td>:</td><td><input type="text" name="nama" size="35" maxlength="50"></td></tr>
...
$indikator = $hijau;					
    ...
    $logbook = mysqli_query($koneksi, "SELECT * from logbook ORDER BY id DESC, status DESC LIMIT 20");
