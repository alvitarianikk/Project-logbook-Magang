...
<tr><td><font color="#000000">Parts of Equipment</td><td>:</td><td><input type="text" name="bagianalat" size="85" maxlength="500" value="<?php echo $row['bagianalat'];?>"></textarea></tr></td>
<tr><td><font color="#000000">Description</td><td>:</td><td><input type="text" name="detailrusak" size="85" maxlength="500" value="<?php echo $row['detailrusak'];?>"></textarea></tr></td>
<tr><td><font color="#000000">Repair</td><td>:</td><td><input type="text" name="perbaikan" size="85" maxlength="500" value="<?php echo $row['perbaikan'];?>"></textarea></td></tr>
