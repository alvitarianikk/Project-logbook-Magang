...
<body>
    <ul class="navbar">
    <li><a href="home.php" style="text-decoration:none"><font color="#FFFFFF">Home</a></li></font>
    <li><a href="#" style="text-decoration:none"><font color="#FFFFFF">Suku Cadang</a></li></font>
    <li><a href="karyawanlogin.php" style="text-decoration:none"><font color="#FFFFFF">Isi Log book</a></li></font>
