...
<tr><td><font color="#000000">Damage Date(YY-MM-DD)</td><td>:</td><td><input type="text" name="tanggal" size="15" maxlength="50"></td>
</tr>
<tr><td><font color="#000000">Damage Time(HH:MM:SS)</td><td>:</td><td><input type="text" name="waktuindo" size="35" maxlength="50"></td></tr>

<tr><td><font color="#000000">Normal Date <br> (YY-MM-DD)</td><td>:</td><td><input type="text" name="tanggalnormal" size="35" maxlength="50"></td></tr>
<tr><td><font color="#000000">Normal Time (HH:MM:SS)</td><td>:</td><td><input type="text" name="waktuus" size="35" maxlength="50"></td></tr>
<tr><td><font color="#000000">Input By </td><td>:</td><td><input type="text" name="nama" size="35" maxlength="50"></td></tr>
<tr><td><font color="#000000">Facility</td><td>:</td><td><select name="fasilitas">
<option value="Communication">Communication</option>
<option value="Navigation">Navigation</option>
<option value="Surveillance">Surveillance</option>
<option value="Automation">Automation</option></tr></td>

<tr><td><font color="#000000">Equipment</td><td>:</td><td><input type="text" name="peralatan" size="35" maxlength="50"></td></tr>
<tr><td><font color="#000000">Merk Type</td><td>:</td><td><input type="text" name="merk" size="35" maxlength="50"></td></tr>
<tr><td><font color="#000000">Parts of Equipment</td><td>:</td><td><textarea name="bagianalat" rows="5" cols="30"></textarea></tr></td>
<tr><td><font color="#000000">Description</td><td>:</td><td><textarea name="detailrusak" rows="5" cols="30"></textarea></tr></td>
<tr><td><font color="#000000">Repair</td><td>:</td><td><textarea name="perbaikan" rows="5" cols="30"></textarea></td></tr>
<tr><td><font color="#000000">Status</td><td>:</td><td><input type="hidden" name="status"></td></tr></p>
</tr></table>

<input type="submit" value="Simpan"><input type="reset" value="Reset"><br>
</form>
<BR>
...
$indikator = $hijau;					
    ...
    $logbook = mysqli_query($koneksi, "SELECT * from logbook ORDER BY id DESC, status DESC LIMIT 5");
